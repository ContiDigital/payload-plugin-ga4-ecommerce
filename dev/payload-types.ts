...
export interface TestProduct {
  ...
  stock?: number | null;
  stockStatus?: ('in-stock' | 'out-of-stock' | 'finished-production') | null;
  productCategories?: (number | TestCategory)[] | null;
  slug?: string | null;
  updatedAt: string;
  createdAt: string;
...
export interface TestCategory {
  ...
  description?: string | null;
  order?: number | null;
  parentId?: (number | null) | TestCategory;
...
export interface PayloadLockedDocument {
  ...
  document?:
    ...
    | ({
        ...
        value: number | TestProduct;
      } | null)
    | ({
        relationTo: 'test-categories';
        value: number | TestCategory;
      } | null)
    | ({
        relationTo: 'test-pages';
        value: number | TestPage;
      } | null)
    | ({
        relationTo: 'users';
        value: number | User;
